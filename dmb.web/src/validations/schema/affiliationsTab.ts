...
export const affiliationItemFormSchema = Yup.object({
  organization: nonEmptyTrimmedString("Organization"),
  title: nonEmptyTrimmedString("Title"),
  issueDate: isoDateRequired("Issue date"),
  details: nonEmptyTrimmedString("Details"),
});
